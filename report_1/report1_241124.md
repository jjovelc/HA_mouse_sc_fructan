...
For each tissue, differential expression analysis, between control and B-fructan groups was conducted. 

#### Differentially expressed genes for gut (cecum) cells

<table>
  <tr>
    <td><img src="figures/gut_EnhancedVolcano_B-fructan_vs_Control.png" alt="gut_EnhancedVolcano_B-fructan_vs_Control.png" width="500"></td>
  </tr>
</table>
